    ...
    if args.dumpSites == 1 or args.dumpSites == 3:
        for type in tqdm(PAIRED_SICK_HEALTHY.keys()):
            ...
            if args.filesExist:
                ...
                #TODO delete unshuffled X,Y,sample_weight,features_names?
            # shuffle this data
            ...
            dump_sites_to_tsv("%s/sickHealthy/%s/site_predictions_%s.tsv" % (args.outpath, type, type), final_df)
